let x_routes = {
  ...
  "todo.project":{x_api : "/api/project",x_page:"./static/pages/todo/project.htm?v0.01"},
  "todo.projects":{x_page:"./static/pages/todo/project_hrdr.htm?v0.01",x_code:"/static/pages/todo/project_hrdr.js"},
...
let x_actions = {
  ...
  "todo.project.del": {x_act:"del",x_do:"/api/project",x_go:"todo.project_list"},
}	
